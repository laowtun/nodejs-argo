...
const UUID = process.env.UUID || 'c719d6b2-47ce-4394-a5aa-3afd7d67b076'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
const NEZHA_SERVER = process.env.NEZHA_SERVER || '';        // 哪吒v1填写形式: nz.abc.com:8008  哪吒v0填写形式：nz.abc.com
const NEZHA_PORT = process.env.NEZHA_PORT || '';            // 使用哪吒v1请留空，哪吒v0需填写
const NEZHA_KEY = process.env.NEZHA_KEY || '';              // 哪吒v1的NZ_CLIENT_SECRET或哪吒v0的agent密钥
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'dcdeploy.bbk.qzz.io';          // 固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiNGU5ZDZmYTdiNzkwZDY4NTM5MGY3YTM4MjI2NGMyZTYiLCJ0IjoiNGYxYmEyZWYtYjliZS00NWE5LWI2YTgtODlkNjc0OWEyOGJkIiwicyI6Ik5tUXhOVGM0TURndE5XTXdOeTAwWmpKakxXSmtaVGd0Tm1ZNVlqbGxZV0UxT0daaiJ9';              // 固定隧道密钥json或token,留空即启用临时隧道,json获取地址：https://json.zone.id
...
const CFIP = process.env.CFIP || 'visa.com.tw';            // 节点优选域名或优选ip
